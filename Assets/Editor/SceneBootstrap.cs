...
namespace BlackjackGame.EditorTools
{
    ...
    public static class SceneBootstrap
    {
        ...
        private static void BuildGameScene()
        {
            ...
            TMP_Text balanceLabel = CreateText(canvas.transform, "BalanceLabel", "Chips: 0",
                new Vector2(0f, 855f), new Vector2(1000f, 80f), 52f,
                TextAlignmentOptions.Center, TextStyle.DisplayGold);

            // --- dealer ---------------------------------------------------------
            CreatePanel(canvas.transform, "DealerPanel", new Vector2(0f, 590f), new Vector2(1000f, 340f), GlassPanel);
            TMP_Text dealerHandLabel = CreateText(canvas.transform, "DealerHandLabel", "Dealer",
                new Vector2(0f, 715f), new Vector2(960f, 70f), 46f,
            ...
            TMP_Text playerHandLabel = CreateText(canvas.transform, "PlayerHandLabel", "Place your bet",
                new Vector2(0f, 205f), new Vector2(960f, 70f), 46f,
                TextAlignmentOptions.Center, TextStyle.BodyGold);
            HandView playerHandView = CreateHandView(canvas.transform, "PlayerHandView", new Vector2(0f, 35f));

            TMP_Text outcomeLabel = CreateText(canvas.transform, "OutcomeLabel", "",
                new Vector2(0f, -160f), new Vector2(1000f, 100f), 58f,
                TextAlignmentOptions.Center, TextStyle.DisplayGold);

            TMP_InputField betInput = CreateInputField(canvas.transform, "BetInput", "100",
        ...
        private static void DeleteObsoleteBakedLabels()
        {
            ...
            if (removed > 0)
                Debug.Log($"[SceneBootstrap] Removed {removed} obsolete baked label sprite(s) — now TextMeshPro.");
        }
